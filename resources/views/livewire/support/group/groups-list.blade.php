    ...
    <div class="mb-3 ms-2 col-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style2 mb-0">
                ...
                <li class="breadcrumb-item active h5">لیست گروه ها</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="{{ route('dashboard.groups.add') }}" class="btn btn-primary w-100">+ افزودن گروه جدید</a>
            </div>
        </div>
        <div class="table-responsive text-nowrap">
            <table class="table table-hover">
                ...
                @empty
                    <div class="alert alert-primary shadow-sm w-75">
                        <span class="text-white">رکوردی یافت نشد</span>
                    </div>
                @endforelse
