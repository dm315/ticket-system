...
<div>
    ...
    <div class="mb-3 ms-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style2 mb-0">
                ...
                <li class="breadcrumb-item active h5">تعریف پــروژه</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="col-12 mb-4">
        <h4 class="text-light fw-semibold">تعریف پـــروژه</h4>
                ...
                <div class="step {{ $formStep == 1 ? 'active' : '' }}" x-on:click="$wire.set('formStep', '1')">
                    <button type="button" class="step-trigger">
                        ...
                        <span class="bs-stepper-label mt-1">
                           <span class="bs-stepper-title">تعریف پروژه</span>
                ...
                <form wire:submit="store" enctype="multipart/form-data">
                    ...
                    <div class="content {{ $formStep != 1 ? 'd-none' : '' }}">
                        <div class="content-header mb-3">
                            <h6 class="mb-0">تعریف پـــروژه</h6>
                        </div>
                        <div class="row g-3">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div wire:ignore>
                                    <select id="selectpickerBasic"
                                        ...
                                        <option value="2">زمان دار</option>
                                    </select>
                                </div>
                                @error('form.priority')
                                <div class="w-100 text-center">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" id="date_end" wire:model="form.end_date"
                                       class="form-control @error('form.end_date') border-error @enderror"
                                       data-jdp
                                ...
                                <div wire:ignore>
                                    <select id="group_id"
                                        ...
                                        @foreach($groups as $group)
                                            <option value="{{ $group->id }}">{{ $group->name }} - ( {{ $group->groupLeader->fullName }} )</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('form.group_id')
