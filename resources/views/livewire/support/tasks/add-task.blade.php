...
<div>
    ...
    <div class="col-12 my-4">
        <h3 class="text-light fw-semibold">ایجــــاد تـســـک</h3>
                ...
                <form wire:submit="store">
                                    ...
                                    <div class="col-md mb-md-0 mb-2">
                                        <div class="form-check custom-option custom-option-basic">
                                            <label class="form-check-label custom-option-content"
                                                ...
                                                <input name="customRadioTemp" wire:model="type"
                                                       class="form-check-input"
                                                       type="radio"
                                                       value="0" id="customRadioTemp1" checked>
                    ...
                    <div id="personal-info-vertical"
                        ...
                        <div class="content-header mb-3">
                            ...
                            <small class="d-block">فایل های مجاز: ( jpeg,png,jpg,zip,pdf )</small>
                        </div>
                        <div class="row g-3">
                    ...
                    <div id="social-links-vertical"
                        ...
                        <div class="row g-3">
                                                ...
                                                <div class="mb-3 col-6">
                                                    ...
                                                    <span class="input-group-text" id="search_receiver"><i
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               aria-label="Search..."
                                                               wire:model.live.debounce.500="searchUser"
                                                               aria-describedby="basic-addon-search31">
                                                    </div>
                                                </div>
                                                <div class="mb-3 col-6">
                                                    <label for="search_receiver">انتخاب نوع کاربر</label>
                                                    <div class="input-group input-group-merge">
                            ...
                            <div class="col-12 d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-success btn-submit">ایجاد تسک</button>
                            </div>
                        </div>
                    </div>
                </form>
