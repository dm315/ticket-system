    ...
    <div class="mb-3 ms-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style2 mb-0">
                ...
                <li class="breadcrumb-item">
                    <a href="javascript:void(0);" class="h5">نامه ها</a>
                </li>
                <li class="breadcrumb-item active h5">لیست تســک های {{ $is_owner ? 'ارسالی' : 'دریافت شده' }}</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="card-datatable table-responsive">
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                <div class="card-header flex-column flex-md-row">
                    <div class="head-label text-center"><h5 class="card-title mb-0">لیست تســـک
                            های {{ $is_owner ? 'ارسالی' : 'دریافتی' }} -
                        ...
                        <div class="dt-buttons flex-wrap">
                            ...
                            <button type="button" wire:click.prevent="recycleBin"
                                    class="btn btn-label-facebook me-2" tabindex="0"><span><i
                                        class="fas fa-trash-arrow-up"></i> <span class="d-none d-sm-inline-block">سطل زباله ({{ auth()->user()->tasks()->onlyTrashed()->count() }})</span></span>
                            </button>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-9 d-flex justify-content-start">
                        ...
                        <div class="dataTables_length ms-3" id="DataTables_Table_0_length"><label>
                                نوع تســـک:
                                <select
                        ...
                        <div class="dataTables_length ms-3" id="DataTables_Table_0_length">
                            <label>
                                نوع مشاهده:
                                <select
                                    wire:model.live="is_owner"
                                    class="form-select form-select-sm">
                                    <option value="0">تسک های دریافتی</option>
                                    <option value="1" selected>تسک های ارسالی</option>
                                </select>
                            </label>
                        </div>
                    </div>
                        ...
                        <tr class="{{ $key % 2 == 0 ? 'even' : 'odd' }}" wire:key="{{ $task->id }}">
                            ...
                            @else
                                <td>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                        <li>
                                            <a class="dropdown-item" role="button" type="button">
                                                <i class="fa-regular fa-eye"></i> جزییات
                                            </a>
                                        </li>
                                        <li>
